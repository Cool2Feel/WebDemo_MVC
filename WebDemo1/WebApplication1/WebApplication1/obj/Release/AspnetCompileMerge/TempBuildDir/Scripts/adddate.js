...
//是已被选中的单元格
            ...
            tds[i].onclick = function () {
                ...
                $('#calendarToday').click(); //2016-06-24 Czhan,选中日期关闭
                $('#calendarClose').click(); //2016-06-24 Czhan,选中日期关闭
            }
...
//以下由Czhan 2016-06-23 日历绝对定位
function InitContainerPanelF() //初始化容器
{
    var str = '<div id="calendarPanel" style="position: fixed;display: none;z-index:9999; background-color: #FFFFFF;border: 1px solid #CCCCCC;width:245px;font-size:12px;"></div>';
    if(document.all)
    {
        str += '<iframe style="position:absolute;z-index:2000;width:expression(this.previousSibling.offsetWidth);';
        str += 'height:expression(this.previousSibling.offsetHeight);';

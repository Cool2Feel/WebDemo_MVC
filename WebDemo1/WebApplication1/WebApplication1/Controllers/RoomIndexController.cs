...
namespace WebApplication1.Controllers
{
    public class RoomIndexController : Controller
    {
        ...
        */
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Create([Bind(Include = "ID,Name,Number,StartTime,EndTime,Tips,Status,Page,Postion")] RoomModels roomModels)
        {
        ...
        [ChildActionOnly]
        public ActionResult LoadChange(string s)
        {
            /*
            int id = int.Parse(s);
            RoomModels room = db.RoomModels.Find(id);
